    ...
    def from_config(cls, cfg, from_pretrained=False):
        ...
        if vit_type == "base":
            ...
            if from_pretrained:
                ...
                default_cfg = default_cfgs["vit_large_patch16_224_in21k"] or getattr(visual_encoder, 'default_cfg', None) or {}
                ...
                # state_dict = state_dict = weights["model"]
                # interpolate_pos_embed(
                #     visual_encoder, state_dict
                # )
                visual_encoder.load_pretrained(cached_file)  
